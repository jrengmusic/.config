local buffer_utils = require("highlight-colours.buffer_utils")
local css_named_colors = require("highlight-colours.named-colors.css")
local tailwind_named_colors = require("highlight-colours.named-colors.tailwind")
local converters = require("highlight-colours.color.converters")
local patterns = require("highlight-colours.color.patterns")
local ansi_named_colors = require("highlight-colours.named-colors.ansi")
local xterm256_named_colors = require("highlight-colours.named-colors.xterm256")
...
function M.get_color_value(color, row_offset, custom_colors, enable_short_hex )
	...
	if #hex_color == 9 then
		-- 0xAARRGGBB: drop AA, return #RRGGBB
		hex_color = "#" .. hex_color:sub(4, 9)
	end
