local utils = require("highlight-colours.utils")
local table_utils = require("highlight-colours.table_utils")
local buffer_utils = require("highlight-colours.buffer_utils")
local colors = require("highlight-colours.color.utils")
local color_patterns = require("highlight-colours.color.patterns")
...
---...other configs
---formatting = {
---    format = require("highlight-colours").format
---}
