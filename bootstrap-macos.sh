...
# CAROL output style — ~/.claude/output-styles/carol.md → ~/.carol/output-styles.md
mkdir -p "$HOME/.claude/output-styles"
STYLE_SRC="$HOME/.carol/output-styles.md"
STYLE_DST="$HOME/.claude/output-styles/carol.md"
